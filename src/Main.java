 ...
 */
// продемонстрировать порядок работы выполнения вызова конструкторов статических анонимных  в одиночном классе и если есть наследование
//
// и как будет работать если есть наследие   как вызываются конструктуры потомки и тд
